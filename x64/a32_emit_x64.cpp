...
*/
#include "../frontend/A32/coprocessor.h"

#include "a32_emit_x64.h"
#include "a32_jitstate.h"
#include "abi.h"
#include "block_of_code.h"
#include "devirtualize.h"
#include "emit_x64.h"
//#include "perf_map.h"
...
#include "../frontend/basic_block.h"
#include "../frontend/microinstruction.h"
#include "../frontend/opcodes.h"
...
void A32EmitX64::ReadMemory(A32EmitContext& ctx, IR::Inst* inst) {
    ...
    Xbyak::Label abortx, end;

    const auto src_ptr = EmitVAddrLookup(code, ctx.reg_alloc, config, abortx, vaddr, value);
    switch (bitsize) {
    case 8:
...
void A32EmitX64::WriteMemory(A32EmitContext& ctx, IR::Inst* inst) {
    ...
    const auto dest_ptr = EmitVAddrLookup(code, ctx.reg_alloc, config, abortx, vaddr);
    switch (bitsize) {
    case 8:
